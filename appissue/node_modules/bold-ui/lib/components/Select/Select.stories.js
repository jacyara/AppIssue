...
react_1.storiesOf('Components|Select', module)
    ...
    .add('suggestion', function () { return (react_2.default.createElement(_1.Select, { label: 'Fruit', name: 'fruit', items: fruits, error: addon_knobs_1.text('error', ''), icon: null, createNewItem: function (str) { return ({ value: str, label: str }); }, itemToString: function (item) { return item && item.label; }, itemIsEqual: function (a, b) { return a.value === b.value; }, placeholder: 'Select a value...', multiple: addon_knobs_1.boolean('multiple', false), clearable: addon_knobs_1.boolean('clearable', true), disabled: addon_knobs_1.boolean('disabled', false), openOnFocus: addon_knobs_1.boolean('openOnFocus', false), loading: addon_knobs_1.boolean('loading', false), onChange: addon_actions_1.action('changed'), onBlur: addon_actions_1.action('blur') })); })
    .add('async', function () { return (react_2.default.createElement(SelectAsync_1.SelectAsync, { label: 'Repository', name: 'repository', loadItems: loadFruits, error: addon_knobs_1.text('error', ''), itemToString: function (item) { return item && item.label; }, itemIsEqual: function (a, b) { return a.value === b.value; }, placeholder: 'Select a value...', multiple: addon_knobs_1.boolean('multiple', false), clearable: addon_knobs_1.boolean('clearable', true), disabled: addon_knobs_1.boolean('disabled', false), openOnFocus: addon_knobs_1.boolean('openOnFocus', true), onChange: addon_actions_1.action('changed'), onBlur: addon_actions_1.action('blur') })); })
