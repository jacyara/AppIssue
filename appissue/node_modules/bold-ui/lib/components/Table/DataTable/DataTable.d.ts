...
import { TableHeaderProps, TableProps } from '../Table';
...
export declare function DataTableDefault(props: DataTableRenderProps): JSX.Element;
export declare const defaultColumnStyles: (col: TableColumnConfig<any>) => {
